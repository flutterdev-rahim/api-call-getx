...
List<Product2Model> product2ModelFromJson(String? str) =>
    List<Product2Model>.from(
        json.decode(str!).map((x) => Product2Model.fromJson(x)));

String? product2ModelToJson(List<Product2Model> data) =>
